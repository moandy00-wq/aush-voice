    ...
    <div className="flex min-h-dvh items-center justify-center bg-neutral-50 px-6 dark:bg-black">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm dark:border-white/10 dark:bg-neutral-950">
          <h1 className="font-display text-2xl font-bold text-neutral-950 dark:text-white">Welcome back</h1>
          <p className="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Sign in to your account to continue</p>
        ...
        <p className="mt-6 text-center text-sm text-neutral-500 dark:text-neutral-400">
          ...
          <Link href="/signup" className="font-medium text-amber-600 transition-colors hover:text-amber-500 dark:text-amber-400">
            Sign up
          </Link>
        </p>
      </div>
